...
<header>
    ...
    <nav id="navbar">
        <h2 class="headText">Online Banking System</h2>
        <div class="hamburger">
            <div class="line"></div>
            <div class="line"></div>
            <div class="line"></div>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <table class="table table-hover table-sm table-striped table-condensed table-bordered" style="border-color:black;">
                        <thead style="color : black;">
                            ...
                            <th scope="col" class="text-center py-2">Edit</th>
                ...
                ?>
                    <tr style="color : black;">
                        ...
                        <td><a href="edit.php?id=<?php echo $rows['id']; ?>"><button type="button" class="btn" style="background-color : #7ebd69;">Edit</a></button></td>
                        <td><a href="delete.php?id=<?php echo $rows['id']; ?>"><button type="button" class="btn" style="background-color : #d05757;">Delete</a></td>
